    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                var osscnf = window.parent.ossCnf || {};
                var file_name = osscnf.directory + window.parent.uuid() + '.' + file.blob.ext
                file.blob.img_url = osscnf.host + '/' + file_name
                data.key = file_name
                data.policy = osscnf.policy
                data.OSSAccessKeyId = osscnf.ossAccessKeyId
                data.success_action_status = 200
                data.signature = osscnf.signature
            });
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                var $file = $('#' + file.id);
                try {
                    _this.imageList.push(file.source.img_url);
